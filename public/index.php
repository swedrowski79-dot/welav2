...
use App\Web\Controller\ImageFileController;
...
$router->post('/document-files/reset', [$documentFileController, 'reset']);
$router->get('/image-files', [$imageFileController, 'index']);
$router->get('/image-files/references', [$imageFileController, 'references']);
$router->get('/image-files/browse', [$imageFileController, 'browse']);
$router->get('/image-files/browse-tree', [$imageFileController, 'browseTree']);
$router->post('/image-files/path', [$imageFileController, 'savePath']);
$router->post('/image-files/scan', [$imageFileController, 'scan']);
$router->post('/image-files/upload', [$imageFileController, 'upload']);
$router->post('/image-files/reset', [$imageFileController, 'reset']);
