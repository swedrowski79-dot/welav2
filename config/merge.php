    ...
    'merge' => [
        ...
        'stage_product_translations' => [
            ...
            'fields' => [
                ...
                'short_description' => ['from' => ['raw_extra_article_translations.intro_text'], 'strategy' => 'first_not_empty'],
                'meta_title' => [
                    'from' => [
                ...
                'product_type' => ['from' => ['raw_afs_articles.product_type']],
                'attribute_name1' => ['from' => ['raw_extra_article_translations.attribute_name1', 'raw_afs_articles.attribute_name1'], 'strategy' => 'first_not_empty'],
                'attribute_name2' => ['from' => ['raw_extra_article_translations.attribute_name2', 'raw_afs_articles.attribute_name2'], 'strategy' => 'first_not_empty'],
                'attribute_name3' => ['from' => ['raw_extra_article_translations.attribute_name3', 'raw_afs_articles.attribute_name3'], 'strategy' => 'first_not_empty'],
                'attribute_name4' => ['from' => ['raw_extra_article_translations.attribute_name4', 'raw_afs_articles.attribute_name4'], 'strategy' => 'first_not_empty'],
                'attribute_value1' => ['from' => ['raw_extra_article_translations.attribute_value1', 'raw_afs_articles.attribute_value1'], 'strategy' => 'first_not_empty'],
                'attribute_value2' => ['from' => ['raw_extra_article_translations.attribute_value2', 'raw_afs_articles.attribute_value2'], 'strategy' => 'first_not_empty'],
                'attribute_value3' => ['from' => ['raw_extra_article_translations.attribute_value3', 'raw_afs_articles.attribute_value3'], 'strategy' => 'first_not_empty'],
                'attribute_value4' => ['from' => ['raw_extra_article_translations.attribute_value4', 'raw_afs_articles.attribute_value4'], 'strategy' => 'first_not_empty'],
        ...
        'stage_product_documents' => [
            ...
            'unique_by' => ['afs_artikel_id', 'file_name', 'title', 'source_path'],
            'fields' => [
