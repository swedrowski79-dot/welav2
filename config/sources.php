    ...
    'sources' => [
        ...
        'xt' => [
            ...
            'connection' => [
                ...
                'product_batch_request_max_payload_bytes' => $envInt('XT_PRODUCT_BATCH_REQUEST_MAX_PAYLOAD_BYTES', 0),
                'category_batch_request_size' => $envInt('XT_CATEGORY_BATCH_REQUEST_SIZE', 25),
                'category_batch_request_max_payload_bytes' => $envInt('XT_CATEGORY_BATCH_REQUEST_MAX_PAYLOAD_BYTES', 0),
            ],
        ],
